      ...
      <CardContent sx={{ flexGrow: 1, p: { xs: 2, sm: 2.5 } }}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            <BedIcon sx={{ fontSize: { xs: '1.1rem', sm: '1.2rem' }, color: '#666' }} />
            <Typography
              variant="body2"
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            <BathtubIcon sx={{ fontSize: { xs: '1.1rem', sm: '1.2rem' }, color: '#666' }} />
            <Typography
              variant="body2"
              sx={{ color: '#666', fontSize: { xs: '0.85rem', sm: '0.9rem' } }}
            >
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            <SquareFootIcon sx={{ fontSize: { xs: '1.1rem', sm: '1.2rem' }, color: '#666' }} />
            <Typography
              variant="body2"
              sx={{ color: '#666', fontSize: { xs: '0.85rem', sm: '0.9rem' } }}
            >
